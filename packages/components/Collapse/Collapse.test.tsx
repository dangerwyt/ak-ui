...
describe('Collapse.vue', () => {
  beforeAll(() => {
    ...
    headers = wrapper.findAll('.aka-collapse-item__header');
    contents = wrapper.findAll('.aka-collapse-item__wrapper');
  ...
  test('手风琴模式', async () => {
    ...
    headers = wrapper.findAll('.aka-collapse-item__header');
    contents = wrapper.findAll('.aka-collapse-item__wapper');
